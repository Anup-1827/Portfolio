...
Files: wizard.glb [3.56MB] > D:\Projects\portfolio\public\models\wizard-transformed.glb [3.55MB] (0%)
*/
"use client"
...
export default function Wizard(props) {
  ...
  useFrame((state)=>{
    modelRef.current.position.y =  Math.sin(state.clock.elapsedTime)*0.15 + modelPosition[1]
  })
